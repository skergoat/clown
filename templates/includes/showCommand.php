<div class="col-lg-6 pl-lg-4 mb-xs-none mb-sm-0 mb-lg-5 mb-lg-0 pl-xs-none pr-xs-none pr-sm-0 pr-lg-5 pt-2">
    <!-- title -->
...
<div class="col-lg-6 mb-xs-4 mb-lg-5 mt-xs-4 mt-sm-4 mt-lg-0 p-xs-none pl-xs-none pl-lg-5 pb-3 pt-2">
    <!-- title -->
    <h5 class="black pb-2">Mode de Paiement</h5>
    <span class="border-bottom-orange mb-1"></span>
    <div class="mt-3 mr-4"><img src="../assets/img/logo-check-single.png" class="know-more-icon logo-check-single mb-2" alt="logo lydia"><span class="ml-2 font-17 bold">Chèque</span></div>
</div>
<!-- formulaire -->
...
<!-- text area -->
<div class="col-lg-12 mb-xs-4 mb-lg-0 mt-xs-4 mt-sm-4 mt-lg-2 p-xs-none pb-0 pt-2">
    <!-- title -->
