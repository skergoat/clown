...
<div class="content__product container-width mx-auto">
    <div class="row border-radius-10 m-0 p-xs-4 pb-sm-0 p-5">
        <div class="col-lg-8 pl-xs-none pr-xs-none pr-sm-0 pr-md-5 mt-2 mb-xs-5 mb-sm-5 mb-lg-4">
