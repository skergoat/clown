    ...
    <div class="row p-0 m-0">
        ...
        <div class="col-lg-6 mb-xs-4 mb-lg-0 mt-xs-4 mt-sm-4 mt-lg-0 p-xs-none pl-xs-none pl-lg-5 pb-3 pt-2">
            ...
            <table id="table_address" class="table">
                ...
                <tbody>
                    <tr>
                        <td class="pt-3 pb-3"><a href="#" class="black action-link link-orange" title="modifier" id="link-modal" data-toggle="modal" data-target="#edit-address-modal">Maison</a></td>
