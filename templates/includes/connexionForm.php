<div class="col-lg-6 pl-lg-4 mb-xs-none mb-sm-0 mb-lg-4 mb-lg-0 pl-xs-none pr-xs-none pr-sm-0 pr-lg-5 pt-2">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="font-14 sbold">Prénom</label>
            <input type="text" class="form-control form-large font-14" id="currentpass" value="Théo">
        </div>
        <!-- last name -->
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="font-14 sbold">Nom de famille</label>
            <input type="text" class="form-control form-large font-13" id="address1" placeholder="Votre nom de famille">
        </div>
    </div>
    <!-- row 2 -->
    <div class="form-row">
        <!-- mail -->
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="font-14 sbold">E-mail</label>
            <input type="text" class="form-control form-large font-13" id="currentpass" value="theo@identiteur.fr">
        </div>
        <!-- company -->
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="font-14 sbold">Société (facultatif)</label>
            <input type="text" class="form-control form-large font-13" id="address1" value="theo.graphics">
        </div>
    </div>
    <!-- adress -->
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-14 sbold">Adresse</label>
        <input type="text" class="form-control form-large font-13" id="address2" value="20 rue de Paris">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-14 sbold">Complément d'adresse</label>
    ...
    <div class="form-row">
        <!-- zip code -->
        <div class="form-group col-md-6">
            <label for="exampleInputPassword1" class="font-14 sbold">Code postal</label>
...
<div class="col-lg-6 mb-xs-4 mb-lg-0 mt-xs-4 mt-sm-4 mt-lg-0 p-xs-none pl-xs-none pl-lg-5 pb-3 pt-2">
    ...
    <span class="border-bottom-orange mb-4"></span>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-14 sbold">Mot de passe actuel</label>
        <input type="password" class="form-control form-large font-13" id="currentpass" value="Password">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-14 sbold">Adresse</label>
        <input type="password" class="form-control form-large font-13" id="address1" value="Password">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword1" class="font-14 sbold">Adresse</label>
        <input type="password" class="form-control form-large font-13" id="address2" value="Password">
    </div>
</div>
