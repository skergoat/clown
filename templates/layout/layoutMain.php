               ...
               <div class="nav__primary">
                    <div class="d-flex justify-content-between nav__wrapper">
                        ...
                        <ul class="d-none d-lg-flex mb-0 list menu">
                            ...
                            <li id="active-cart" class="ml-4"><a href="http://localhost:8888/templates/cart.php" class="d-flex align-items-center link-black hover-no-change black pr-1"><i class="icon-basket"></i></a><div class="border-bottom-menu"></div></li>
                        </ul>
                        <!-- Navigation links (hidden by default) -->
                        <div class="d-xs-flex d-sm-flex d-md-flex d-lg-none d-flex">
                            <a href="http://localhost:8888/templates/cart.php" class="d-flex align-items-center font-weight-bold link-black hover-no-change pr-1"><i class="icon-basket"></i></a>
